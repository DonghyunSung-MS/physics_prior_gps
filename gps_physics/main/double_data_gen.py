...
from gps_physics.algorithms.cost.cost import DoublePendulmCost
...
from gps_physics.gym_env.double_pendulum import DoublePendulmEnv
...
def main():
    ...
    env = DoublePendulmEnv(mass, length, dt, max_torque=max_torque)
    sing_pen_cost = DoublePendulmCost(1.0, 0.1, 0.001)
